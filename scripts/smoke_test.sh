...
check_exists "$REPO_ROOT/playbooks/getting-started/README.md" "getting-started playbook"
check_exists "$REPO_ROOT/playbooks/troubleshooting/README.md" "troubleshooting playbook"
...
check_exists "$REPO_ROOT/scripts/validate_input_contracts.sh" "validate_input_contracts.sh"
