...
# A1: required_step_contains intentionally empty — known gap: agent routes to
# case-study/run_vcf_effect.py instead of skills/alphagenome-api/scripts/run_alphagenome_vcf_batch.py
# See DEVELOPMENT_PLAN.md (VCF 输入标准化规划) for fix tracking.
run_case "A1" \
  "Use AlphaGenome to run VCF batch variant effect prediction on case-study/Test.geuvadis.vcf, assembly hg38, output to output/alphagenome/." \
