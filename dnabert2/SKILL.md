...
2. Choose the Transformers loading path by version.
...
3. Validate data format before writing training commands.
...
4. Set DNABERT2-specific training defaults.
...
5. Choose parallel training mode explicitly.
...
6. Report outputs and metrics concretely.
